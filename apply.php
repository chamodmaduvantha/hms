...
if(isset($_POST['apply'])){
    ...
    if(empty($firstname)){
        ...
        $error['apply'] = "Both Passworddo not match";
    }
...
if(isset($error['apply'])){
    $s = $error['apply'];
    $show = "<h5 class='text-center alert alert-dander'>$s</h5>";
}else{
    $show ="";
...
<html>
    ...
    <body style="background-image: url(img/back.jfif); background-size:cover; background-repeat: no-repeat;">
        <?php
